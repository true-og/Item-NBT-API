...
/**
 * Temporary solution to hold Mojang to unmapped Spigot mappings. Note years
 * later: nothing is more permanent than a temporary solution.
 * 
 * @author tr7zw
 *
 */
public class MojangToMapping {
    ...
    private static Map<String, String> MC1_20R4 = new HashMap<String, String>() {

        {
            ...
            put("net.minecraft.core.component.DataComponentHolder#get(net.minecraft.core.component.DataComponentType)",
                    "a");
            put("net.minecraft.world.item.component.CustomData#copyTag()", "c");
            put("net.minecraft.world.item.ItemStack#set(net.minecraft.core.component.DataComponentType,java.lang.Object)",
                    "b");
            ...
            put("net.minecraft.world.item.ItemStack#parseOptional(net.minecraft.core.HolderLookup$Provider,net.minecraft.nbt.CompoundTag)",
                    "a");
            put("net.minecraft.world.level.block.entity.BlockEntity#saveWithId(net.minecraft.core.HolderLookup$Provider)",
                    "c");
            put("net.minecraft.world.level.block.entity.BlockEntity#loadWithComponents(net.minecraft.nbt.CompoundTag,net.minecraft.core.HolderLookup$Provider)",
                    "c");
    ...
    public static Map<String, String> getMapping() {
        ...
        switch (MinecraftVersion.getVersion()) {
            ...
            default:
                // this should never happen, unless a version is forgotten here(like 1.19R3
                // which uses the 1.19R2 mappings)
                throw new NbtApiException(
                        "No fitting mapping found for version " + MinecraftVersion.getVersion() + ". This is a bug!");

    ...
    protected static void entity1v12Below(ClassPool classPool) throws ReflectiveOperationException {
        ...
        for (Object mckey : it) {
            ...
            try {
                ...
                int id = (int) registryId.getClass().getMethod("getId", new Class[] { Object.class }).invoke(registryId,
                        entclass);
                registryId.getClass().getMethod("a", new Class[] { Object.class, int.class }).invoke(registryId,
                        wrapped, id);
